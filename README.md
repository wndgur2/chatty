...
Production CD (ARM64 images, serialized deploys) is summarized in [`contexts/ci-cd.md`](contexts/ci-cd.md).

## API and contracts

REST, Socket.IO payloads, and auth behavior are documented in [`contexts/API_DOCUMENTATION.md`](contexts/API_DOCUMENTATION.md). The database model is in [`contexts/SCHEMA.md`](contexts/SCHEMA.md) (generated schema and migrations live under `backend/prisma/`).

## Documentation index

- Product proposal: [`contexts/PROJECT_PROPOSAL.md`](contexts/PROJECT_PROPOSAL.md)
- API contract: [`contexts/API_DOCUMENTATION.md`](contexts/API_DOCUMENTATION.md)
- Data model: [`contexts/SCHEMA.md`](contexts/SCHEMA.md)
- Backend: [`backend/README.md`](backend/README.md)
- Frontend: [`frontend/README.md`](frontend/README.md)
- Docker / deploy: [`deploy/README.md`](deploy/README.md)
- CI/CD operations: [`contexts/ci-cd.md`](contexts/ci-cd.md)
