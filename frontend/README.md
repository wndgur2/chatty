...
**Also read:** repository overview [`../README.md`](../README.md); API and WebSocket contract [`../documents/development/API_DOCUMENTATION.md`](../documents/development/API_DOCUMENTATION.md).
